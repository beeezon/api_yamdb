...
from .views import UsersViewSet, CommentsViewSet, ReviewsViewSet, CategoriesViewSet, GenresViewSet, TitlesViewSet, UserAPIView #UsersViewSet, 
...
urlpatterns = [
    ...
    path('v1/auth/signup/', UserAPIView.as_view()),
